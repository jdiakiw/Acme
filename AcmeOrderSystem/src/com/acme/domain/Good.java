...
public abstract class Good implements Product, Comparable<Good> {
	...
	static{
		...
		Good.catalog = new ArrayList<Good>();
		Good.catalog.add(glue);
		Good.catalog.add(paint);
		Good.catalog.add(anvil);
		Good.catalog.add(safe);
		Good.catalog.add(balloon);
		Good.catalog.add(pistol);
		Good.catalog.add(nitro);
		Good.catalog.add(oil);
	}
