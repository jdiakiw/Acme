...
public class TestGoods {
	...
	public static void main(String[] args) {
		...
		Solid anvil = new Solid("Acme Anvil", 1668, 0.3, UnitOfMeasureType.CUBIC_METER, false, 5000, 0.5,
				0.5);
		Liquid juice = new Liquid("Acme Juice", 1234, .1, UnitOfMeasureType.GALLON, false, .2, .25);
		...
		System.out.println("The weight of " + juice + " is " + juice.weight());
		...
		System.out.println(juice + " can ship via Post office?" + juice.canShipViaPostOffice());
	}
}
